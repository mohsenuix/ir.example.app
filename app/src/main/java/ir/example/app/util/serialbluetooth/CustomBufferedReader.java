 ...
 * invocation of read() or readNextPacket() could cause bytes to be read from the
...
public class CustomBufferedReader extends Reader {
     ...
     * @exception  IOException  If an I/O error occurs
     */
    String readNextPacket(boolean ignoreLF) throws IOException {
        StringBuffer s = null;
        int startChar;
     ...
     */
    public String readNextPacket() throws IOException {
        return readNextPacket(false);
    }
